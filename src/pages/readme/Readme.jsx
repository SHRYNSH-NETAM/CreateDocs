...
const Readme = () => {
  ...
  return (
    <div className="w-[1500px] h-screen flex flex-col bg-zinc-100">
      ...
      {/* Footer */}
      <div className="bg-zinc-100 text-xs text-zinc-800 pb-1">
        <div className="flex justify-center items-center">Developed by Shreyansh Netam | View the Source Code on GitHub</div>
      </div>
    </div>
  );
};
