...
const Sections = () => {
  ...
  const handleAddSection = () => {
    ...
    toggleSelectedSection(inputSection);
};
    ...
    <>
      <div className="basis-1/2 flex flex-col">
        ...
        <div className="flex-1 m-2 border rounded-md border-zinc-500 flex flex-col overflow-auto scrollbar-custom">
          <div className="h-[0px] overflow-visible flex flex-col">
            ...
            <div className="relative w-auto my-6 mx-auto max-w-3xl">
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                <div className="relative p-6 flex flex-col gap-3 items-center justify-center">
                  ...
                  <form onSubmit={handleAddSection} className="w-full flex flex-col gap-3 items-center">
                    <input
                      type="text"
                      id="first_name"
                      onChange={(e) => setInputSection(e.target.value)}
                      className="w-[450px] bg-zinc-100 border border-zinc-800 text-zinc-800 text-md rounded-md p-2.5"
                      placeholder="Section Title"
                      autoComplete="off"
                      required
                    />
                    <div className="w-full flex gap-5">
                      <button type="submit" className="w-full p-1.5 bg-zinc-700 font-semibold text-zinc-100 rounded-md">Add Section</button>
                      <button
                        type="button"
                        onClick={() => setShowModal(false)}
                        className="w-full p-1.5 bg-zinc-100 border border-zinc-700 text-zinc-700 font-semibold rounded-md">
                        Cancel
                      </button>
                    </div>
                  </form>
